...
CREATE TABLE "league_onboarding" (
    ...
    "players_reviewed_at" TIMESTAMPTZ(3),
    "teams_reviewed_at" TIMESTAMPTZ(3),
    "first_event_created_at" TIMESTAMPTZ(3),
    "scorecards_printed_at" TIMESTAMPTZ(3),
    "first_scores_entered_at" TIMESTAMPTZ(3),
    "created_at" TIMESTAMPTZ(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ(3) NOT NULL,
